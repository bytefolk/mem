    ...
    def setUp(self) -> None:
        ...
        (self.dataset / "queries.jsonl").write_text(
            json.dumps(
                {
                    "id": "q-en-text-exact",
                    "text": "Cassini Saturn hexagonal storm",
                    "language": "en",
                    "slice": "exact",
    ...
    def test_produce_rankings_success(self, mock_query: unittest.mock.MagicMock) -> None:
        mock_query.return_value = (
            [
                {
                    "path": "/research/saturn.md",
                    "snippet": "Cassini observed Saturn hexagonal storm",
                    "score": 0.95,
                }
            ],
            12.5,
