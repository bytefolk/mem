...
function makeImage(folder: string, idx: number, opts: { yearMin?: number; yearMax?: number } = {}): MemFile {
  ...
  return {
    ...
    user_tags: status === 'done' ? [...theme.tags, ...personNames] : [],
    timeline_at: ts,
    geo:
...
function makeNamedFile(opts: {
  ...
  return {
    ...
    user_tags: status === 'done' ? (kind === 'audio' ? ['音频'] : ['文档']) : [],
    timeline_at: ts,
    geo: null,
    source_metadata: {},
    processor_metadata: {},
...
function buildDataset(): MemFile[] {
  ...
  const hero: MemFile = {
    ...
    tags: ['旅行', '云南', '小明', '高中', '2012', '大理'],
    user_tags: ['旅行', '云南', '小明', '高中', '2012'],
    timeline_at: heroTs,
    geo: { lat: 25.706, lon: 100.18 },
    source_metadata: {
      captured_at: '2012-07-14T23:22:00+08:00',
      location: {
        lat: 25.706,
        lon: 100.18,
        accuracy_m: 18,
    ...
    processor_metadata: {
      ...
      width: 4032,
      height: 3024,
      camera_make: 'Mock Camera Co.',
      degraded_steps: ['annotation_model'],
    },
    annotations: [
      {
        id: 'a1111111-1111-4111-8111-111111111111',
        file_id: 'hero-2012-yunnan-xiaoming',
        stable_key: 'description:hero:review',
        kind: 'description',
        value_text: '朋友们在大理洱海边留下的一张夏日合影。',
        confidence: 0.78,
        source: 'model',
        provider: 'mock-vlm',
        processor: 'image',
        analysis_version: 'image-enrichment-v2',
        status: 'pending',
        state_version: 1,
        created_at: '2026-07-29T08:00:02Z',
        updated_at: '2026-07-29T08:00:02Z',
      },
      {
        id: 'a2222222-2222-4222-8222-222222222222',
        file_id: 'hero-2012-yunnan-xiaoming',
        stable_key: 'tag:hero:erhai',
        kind: 'tag',
        value_text: '洱海',
        confidence: 0.91,
        source: 'model',
      ...
      },
      {
        ...
        provider: 'mock-vlm',
        processor: 'image',
        analysis_version: 'image-enrichment-v1',
        status: 'accepted',
        state_version: 2,
      ...
      },
      {
        ...
        state_version: 2,
        decided_by_user_id: 'user-1',
        decided_at: '2026-07-28T08:01:00Z',
        created_at: '2026-07-28T07:00:01Z',
        updated_at: '2026-07-28T08:01:00Z',
      },
      {
        id: 'a6666666-6666-4666-8666-666666666666',
        file_id: 'hero-2012-yunnan-xiaoming',
        stable_key: 'tag:hero:lakeside-v1',
        kind: 'tag',
        value_text: '湖边',
        confidence: 0.72,
        source: 'model',
        ...
        status: 'superseded',
        state_version: 2,
        created_at: '2026-07-28T07:00:02Z',
        updated_at: '2026-07-29T08:00:00Z',
      },
    ],
