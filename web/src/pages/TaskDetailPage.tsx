  ...
  return (
    <div className="mx-auto max-w-6xl px-8 py-9">
      ...
      <header className="mb-7 text-center">
        ...
        {head && (
          <div className="mt-2 flex flex-wrap justify-center gap-x-5 gap-y-2 text-xs text-fg-muted">
        ...
        <div className="space-y-6">
          ...
          <div>
            <div className="mb-3 flex items-baseline justify-between gap-3">
              <h2 className="flex-1 text-center text-sm font-medium text-fg">{t('task.timeline')}</h2>
