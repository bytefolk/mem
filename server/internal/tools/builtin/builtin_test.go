...
func TestRegisterAll_RegistersExpectedToolNames(t *testing.T) {
	...
	want := []string{
		"mem_archive", "mem_checkpoint", "mem_context", "mem_face",
		"mem_feedback", "mem_folder_tree", "mem_forget", "mem_get",
		"mem_info", "mem_list", "mem_ls", "mem_memory_list",
		"mem_mkdir", "mem_mv", "mem_put", "mem_related",
